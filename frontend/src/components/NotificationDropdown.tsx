...
export default function NotificationDropdown({ trigger }: NotificationDropdownProps) {
    ...
    return (
      <div
        ...
        style={{
          ...
          background: notif.is_read ? 'transparent' : 'rgba(59, 130, 246, 0.08)',
        }}
        onMouseEnter={(e) => {
  ...
  const dropdownContent = (
    ...
    >
      ...
      >
        <span style={{ color: '#E2E8F0', fontWeight: 600, fontSize: 14 }}>通知</span>
        <span
      ...
      <div style={{ maxHeight: 400, overflowY: 'auto' }}>
        {loading ? (
          ...
          >
            <InboxOutlined style={{ fontSize: 40, marginBottom: 12, opacity: 0.5 }} />
            <div>暂无通知</div>
          </div>
        ) : (
          <>
